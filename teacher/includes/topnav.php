...
<header class="top-header">
    ...
    <div class="search-container">
        ...
        <input type="text" placeholder="Fənn, material və ya tələbə axtar..." class="search-input" id="global-search"
            autocomplete="off">
    ...
    <div class="header-actions">
        ...
        <div class="user-info">
            ...
            <span class="user-name">
                <?php echo isset($currentUser) ? e($currentUser['first_name'] . ' ' . $currentUser['last_name']) : 'İstifadəçi'; ?>
            </span>
        </div>
    </div>
</header>
