...
<body class="bg-[#060f23]">
    <header
        ...
        <div class="flex items-center gap-4">
            <div
                class="w-10 h-10 lg:w-12 lg:h-12 rounded-2xl bg-emerald-500/20 flex items-center justify-center border border-emerald-500/20">
        ...
        <div class="hidden md:flex items-center gap-6">
            ...
            <?php if ($user['role'] === 'teacher'): ?>
                <button onclick="endWebinar()"
                    class="px-6 py-2.5 bg-rose-500 hover:bg-rose-600 text-white rounded-2xl text-[10px] font-black uppercase tracking-widest transition-all shadow-lg shadow-rose-500/20 active:scale-95">
                    Yayıma Yekun Vur
                </button>
            <?php else: ?>
